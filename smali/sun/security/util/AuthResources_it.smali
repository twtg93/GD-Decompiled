...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v2, "input nullo non valido: {0}"
    ...
    const-string/jumbo v3, "Valore NTSid non valido"
    ...
    const-string/jumbo v3, "UnixNumericGroupPrincipal [gruppo primario]: {0}"
    ...
    const-string/jumbo v3, "UnixNumericGroupPrincipal [gruppo supplementare]: {0}"
    ...
    const-string/jumbo v3, "Impossibile espandere correttamente {0}"
    ...
    const-string/jumbo v3, "{0} (file o directory inesistente)"
    ...
    const-string/jumbo v3, "Impossibile trovare una configurazione di login"
    ...
    const-string/jumbo v3, "Errore di configurazione:\n\tflag di controllo non valido, {0}"
    ...
    const-string/jumbo v3, "Nome utente: "
    ...
    const-string/jumbo v3, "Inserire le informazioni per il keystore"
    ...
    const-string/jumbo v3, "Alias keystore: "
    ...
    const-string/jumbo v3, "Password keystore: "
    ...
    const-string/jumbo v3, "Password chiave privata (opzionale): "
    ...
    const-string/jumbo v3, "Nome utente Kerberos [{0}]: "
    ...
    const-string/jumbo v3, "Password Kerberos per {0}: "
    ...
    const-string/jumbo v3, ": errore nell\'analisi "
    ...
    const-string/jumbo v3, ": errore nell\'aggiunta del permesso "
    ...
    const-string/jumbo v3, ": errore nell\'aggiunta dell\'entry "
    ...
    const-string/jumbo v3, "tentativo di aggiungere un permesso a una PermissionCollection di sola lettura"
    ...
    const-string/jumbo v3, "impossibile specificare Principal con una "
    ...
    const-string/jumbo v3, "classe wildcard senza un nome wildcard"
    ...
    const-string/jumbo v3, "previsto codeBase o SignedBy"
    ...
    const-string/jumbo v3, "sono permessi solo valori garantiti basati su Principal"
    ...
    const-string/jumbo v3, "previsto "
    ...
    const-string/jumbo v3, ", letto end of file"
    ...
    const-string/jumbo v3, "SolarisNumericGroupPrincipal [gruppo primario]: "
    ...
    const-string/jumbo v3, "SolarisNumericGroupPrincipal [gruppo supplementare]: "
