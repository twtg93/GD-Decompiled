...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v3, "erreur keytool : "
    ...
    const-string/jumbo v3, "Option non valide :  "
    ...
    const-string/jumbo v3, "Essayez keytool -help"
    ...
    const-string/jumbo v3, "L\'option de commande {0} requiert un argument."
    ...
    const-string/jumbo v3, "Avertissement\u00a0:  Les mots de passe store et key distincts ne sont pas pris en charge pour les keystores PKCS12. La valeur {0} sp\u00e9cifi\u00e9e par l\'utilisateur est ignor\u00e9e."
    ...
    const-string/jumbo v3, "-keystore doit \u00eatre d\u00e9fini sur NONE si -storetype est {0}"
    ...
    const-string/jumbo v3, "Trop de tentatives, fin du programme"
    ...
    const-string/jumbo v3, "Les commandes -storepasswd et -keypasswd ne sont pas prises en charge si -storetype est d\u00e9fini sur {0}"
    ...
    const-string/jumbo v3, "Les commandes -keypasswd ne sont pas prises en charge si -storetype est d\u00e9fini sur PKCS12"
    ...
    const-string/jumbo v3, "Les commandes -keypass et -new ne peuvent pas \u00eatre sp\u00e9cifi\u00e9es si -storetype est d\u00e9fini sur {0}"
    ...
    const-string/jumbo v3, "si -protected est sp\u00e9cifi\u00e9, alors -storepass, -keypass et -new ne doivent pas \u00eatre sp\u00e9cifi\u00e9s"
    ...
    const-string/jumbo v3, "Si \u0096srcprotected est sp\u00e9cifi\u00e9, alors -srcstorepass et \u0096srckeypass ne doivent pas \u00eatre sp\u00e9cifi\u00e9s"
    ...
    const-string/jumbo v3, "Si le keystore n\'est pas prot\u00e9g\u00e9 par un mot de passe, les commandes -storepass, -keypass et -new ne doivent pas \u00eatre sp\u00e9cifi\u00e9es"
    ...
    const-string/jumbo v3, "Si le keystore source n\'est pas prot\u00e9g\u00e9 par un mot de passe, les commandes -srcstorepass et -srckeypass ne doivent pas \u00eatre sp\u00e9cifi\u00e9es"
    ...
    const-string/jumbo v3, "La validit\u00e9 doit \u00eatre sup\u00e9rieure \u00e0 z\u00e9ro"
    ...
    const-string/jumbo v3, "{0} n\'\'est pas un fournisseur"
    ...
    const-string/jumbo v3, "Erreur d\'utilisation\u00a0: aucune commande fournie"
    ...
    const-string/jumbo v3, "Erreur d\'utilisation, {0} n\'est pas une commande valide"
    ...
    const-string/jumbo v3, "Le fichier du keystore source existe, mais il est vide\u00a0: "
    ...
    const-string/jumbo v3, "veuillez sp\u00e9cifier -srckeystore"
    ...
    const-string/jumbo v3, "-v et -rfc ne peuvent \u00eatre sp\u00e9cifi\u00e9s simultan\u00e9ment avec la commande \'list\'"
    ...
    const-string/jumbo v3, "Un mot de passe de cl\u00e9 doit comporter au moins 6 caract\u00e8res"
    ...
    const-string/jumbo v3, "Le nouveau mot de passe doit comporter au moins 6 caract\u00e8res"
    ...
    const-string/jumbo v3, "Fichier Keystore existant mais vide : "
    ...
    const-string/jumbo v3, "Fichier Keystore introuvable : "
    ...
    const-string/jumbo v3, "L\'alias de destination doit \u00eatre sp\u00e9cifi\u00e9"
    ...
    const-string/jumbo v3, "Vous devez sp\u00e9cifier un alias"
    ...
    const-string/jumbo v3, "Un mot de passe de Keystore doit comporter au moins 6 caract\u00e8res"
    ...
    const-string/jumbo v3, "Tapez le mot de passe du Keystore :  "
    ...
    const-string/jumbo v3, "Saisissez le mot de passe du keystore source\u00a0:  "
    ...
    const-string/jumbo v3, "Saisissez le mot de passe du keystore de destination\u00a0:  "
    ...
    const-string/jumbo v3, "Mot de passe de Keystore trop court, il doit compter au moins 6 caract\u00e8res"
    ...
    const-string/jumbo v3, "Type d\'entr\u00e9e inconnu"
    ...
    const-string/jumbo v3, "Trop d\'erreurs. Alias non modifi\u00e9"
    ...
    const-string/jumbo v3, "L\'entr\u00e9e de l\'alias {0} a \u00e9t\u00e9 import\u00e9e."
    ...
    const-string/jumbo v3, "L\'entr\u00e9e de l\'alias {0} n\'a pas \u00e9t\u00e9 import\u00e9e."
    ...
    const-string/jumbo v3, "Probl\u00e8me lors de l\'importation de l\'entr\u00e9e de l\'alias {0}\u00a0: {1}.\nL\'entr\u00e9e de l\'alias {0} n\'a pas \u00e9t\u00e9 import\u00e9e."
    ...
    const-string/jumbo v3, "Commande d\'importation ex\u00e9cut\u00e9e\u00a0:  {0} entr\u00e9es import\u00e9es, \u00e9chec ou annulation de {1} entr\u00e9es"
    ...
    const-string/jumbo v3, "Avertissement\u00a0: L\'alias existant {0} est \u00e9cras\u00e9 dans le keystore de destination"
    ...
    const-string/jumbo v3, "L\'alias d\'entr\u00e9e {0} existe d\u00e9j\u00e0, voulez-vous l\'\u00e9craser\u00a0? [non]\u00a0:  "
    ...
    const-string/jumbo v3, "Trop d\'erreurs - r\u00e9essayez plus tard"
    ...
    const-string/jumbo v3, "Demande de certification enregistr\u00e9e dans le fichier <{0}>"
    ...
    const-string/jumbo v3, "Soumettre \u00e0 votre CA"
    ...
    const-string/jumbo v3, "si l\'alias n\'est pas sp\u00e9cifi\u00e9, destalias, srckeypass et destkeypass ne doivent pas \u00eatre sp\u00e9cifi\u00e9s"
    ...
    const-string/jumbo v3, "Certificat enregistr\u00e9 dans le fichier <{0}>"
    ...
    const-string/jumbo v3, "R\u00e9ponse de certificat install\u00e9e dans le Keystore"
    ...
    const-string/jumbo v3, "R\u00e9ponse de certificat non install\u00e9e dans le Keystore"
    ...
    const-string/jumbo v3, "Certificat ajout\u00e9 au Keystore"
    ...
    const-string/jumbo v3, "Certificat non ajout\u00e9 au Keystore"
    ...
    const-string/jumbo v3, "[Stockage de {0}]"
    ...
    const-string/jumbo v3, "{0} ne poss\u00e8de pas de cl\u00e9 publique (certificat)"
    ...
    const-string/jumbo v3, "Impossible de d\u00e9duire l\'algorithme de signature"
    ...
    const-string/jumbo v3, "Alias <{0}> introuvable"
    ...
    const-string/jumbo v3, "L\'\'alias <{0}> ne poss\u00e8de pas de certificat"
    ...
    const-string/jumbo v3, "Paire de cl\u00e9s non g\u00e9n\u00e9r\u00e9e, l\'\'alias <{0}> existe d\u00e9j\u00e0"
    ...
    const-string/jumbo v3, "G\u00e9n\u00e9ration d\'\'une paire de cl\u00e9s {1} de {0} bits et d\'\'un certificat autosign\u00e9 ({2}) d\'\'une validit\u00e9 de {3} jours\n\tpour : {4}"
    ...
    const-string/jumbo v3, "Sp\u00e9cifiez le mot de passe de la cl\u00e9 pour <{0}>"
    ...
    const-string/jumbo v3, "\t(appuyez sur Entr\u00e9e s\'il s\'agit du mot de passe du Keystore) :  "
    ...
    const-string/jumbo v3, "Le mot de passe de cl\u00e9 doit comporter au moins 6 caract\u00e8res."
    ...
    const-string/jumbo v3, "Trop d\'erreurs - cl\u00e9 non ajout\u00e9e au Keystore"
    ...
    const-string/jumbo v3, "L\'\'alias de la destination <{0}> existe d\u00e9j\u00e0"
    ...
    const-string/jumbo v3, "Le mot de passe doit comporter au moins 6 caract\u00e8res."
    ...
    const-string/jumbo v3, "Trop d\'erreurs. Entr\u00e9e de cl\u00e9 non clon\u00e9e"
    ...
    const-string/jumbo v3, "mot de passe de cl\u00e9 pour <{0}>"
    ...
    const-string/jumbo v3, "L\'\'entr\u00e9e Keystore pour <{0}> existe d\u00e9j\u00e0"
    ...
    const-string/jumbo v3, "Cr\u00e9ation d\'\'une entr\u00e9e keystore pour <{0}> ..."
    ...
    const-string/jumbo v3, "Aucune entr\u00e9e ajout\u00e9e \u00e0 partir de la base de donn\u00e9es d\'identit\u00e9s"
    ...
    const-string/jumbo v3, "Nom d\'\'alias : {0}"
    ...
    const-string/jumbo v3, "Date de cr\u00e9ation : {0,date}"
    ...
    const-string/jumbo v3, "Type d\'entr\u00e9e\u00a0: {0}"
    ...
    const-string/jumbo v3, "Longueur de cha\u00eene du certificat : "
    ...
    const-string/jumbo v3, "Certificat[{0,number,integer}]:"
    ...
    const-string/jumbo v3, "Empreinte du certificat (MD5) : "
    ...
    const-string/jumbo v3, "Type d\'entr\u00e9e : trustedCertEntry\n"
    ...
    const-string/jumbo v3, "Type Keystore : "
    ...
    const-string/jumbo v3, "Fournisseur Keystore : "
    ...
    const-string/jumbo v3, "Votre Keystore contient {0,number,integer} entr\u00e9e(s)"
    ...
    const-string/jumbo v3, "L\'analyse de l\'entr\u00e9e a \u00e9chou\u00e9"
    ...
    const-string/jumbo v3, "Entr\u00e9e vide"
    ...
    const-string/jumbo v3, "Pas un certificat X.509"
    ...
    const-string/jumbo v3, "{0} ne poss\u00e8de pas de cl\u00e9 publique"
    ...
    const-string/jumbo v3, "{0} ne poss\u00e8de pas de certificat X.509"
    ...
    const-string/jumbo v3, "Nouveau certificat (auto-sign\u00e9) :"
    ...
    const-string/jumbo v3, "La r\u00e9ponse n\'a pas de certificat"
    ...
    const-string/jumbo v3, "Certificat non import\u00e9, l\'\'alias <{0}> existe d\u00e9j\u00e0"
    ...
    const-string/jumbo v3, "L\'entr\u00e9e n\'est pas un certificat X.509"
    ...
    const-string/jumbo v3, "Le certificat existe d\u00e9j\u00e0 dans le Keystore sous l\'\'alias <{0}>"
    ...
    const-string/jumbo v3, "Voulez-vous toujours l\'ajouter ? [non] :  "
    ...
    const-string/jumbo v3, "Le certificat existe d\u00e9j\u00e0 dans le Keystore CA syst\u00e8me sous l\'\'alias <{0}>alias <{0}>"
    ...
    const-string/jumbo v3, "Voulez-vous toujours l\'ajouter \u00e0 votre Keystore ? [non] :  "
    ...
    const-string/jumbo v3, "Faire confiance \u00e0 ce certificat ? [non] :  "
    ...
    const-string/jumbo v3, "Nouveau {0} : "
    ...
    const-string/jumbo v3, "Les mots de passe doivent diff\u00e9rer"
    ...
    const-string/jumbo v3, "Sp\u00e9cifiez nouveau {0} : "
    ...
    const-string/jumbo v3, "Ressaisissez le nouveau mot de passe : "
    ...
    const-string/jumbo v3, "ne correspondent pas. R\u00e9essayez."
    ...
    const-string/jumbo v3, "Sp\u00e9cifiez le nom d\'\'alias {0} :  "
    ...
    const-string/jumbo v3, "Saisissez le nom du nouvel alias\t(ou appuyez sur ENTR\u00c9E pour annuler l\'importation pour cette entr\u00e9e)\u00a0:  "
    ...
    const-string/jumbo v3, "Sp\u00e9cifiez le nom d\'alias :  "
    ...
    const-string/jumbo v3, "\t(appuyez sur Entr\u00e9e si le r\u00e9sultat est identique \u00e0 <{0}>)"
    ...
    const-string/jumbo v3, "Quels sont vos pr\u00e9nom et nom ?"
    ...
    const-string/jumbo v3, "Quel est le nom de votre unit\u00e9 organisationnelle ?"
    ...
    const-string/jumbo v3, "Quelle est le nom de votre organisation ?"
    ...
    const-string/jumbo v3, "Quel est le nom de votre ville de r\u00e9sidence ?"
    ...
    const-string/jumbo v3, "Quel est le nom de votre \u00e9tat ou province ?"
    ...
    const-string/jumbo v3, "Quel est le code de pays \u00e0 deux lettres pour cette unit\u00e9 ?"
    ...
    const-string/jumbo v3, "Est-ce {0} ?"
    ...
    const-string/jumbo v3, "L\'alias <{0}> n\'est associ\u00e9 \u00e0 aucune cl\u00e9"
    ...
    const-string/jumbo v3, "L\'entr\u00e9e \u00e0 laquelle l\'alias <{0}> fait r\u00e9f\u00e9rence n\'est pas une entr\u00e9e de type cl\u00e9 priv\u00e9e.  La commande -keyclone prend uniquement en charge le clonage des cl\u00e9s priv\u00e9es"
    ...
    const-string/jumbo v3, "*****************  A V E R T I S S E M E N T  *****************"
    ...
    const-string/jumbo v3, "* L\'int\u00e9grit\u00e9 des informations enregistr\u00e9es dans votre Keystore  *"
    ...
    const-string/jumbo v3, "* L\'int\u00e9grit\u00e9 des informations enregistr\u00e9es dans srckeystore*"
    ...
    const-string/jumbo v3, "* n\'a PAS \u00e9t\u00e9 v\u00e9rifi\u00e9e !  Pour cela, *"
    ...
    const-string/jumbo v3, "* vous devez sp\u00e9cifier le mot de passe de votre Keystore.                  *"
    ...
    const-string/jumbo v3, "* vous devez fournir le mot de passe srckeystore.                *"
    ...
    const-string/jumbo v3, "La r\u00e9ponse au certificat ne contient pas de cl\u00e9 publique pour <{0}>"
    ...
    const-string/jumbo v3, "Cha\u00eene de certificat incompl\u00e8te dans la r\u00e9ponse"
    ...
    const-string/jumbo v3, "La cha\u00eene de certificat de la r\u00e9ponse ne concorde pas : "
    ...
    const-string/jumbo v3, "Certificat du plus haut niveau dans la r\u00e9ponse :\n"
    ...
    const-string/jumbo v3, "... n\'est pas digne de confiance. "
    ...
    const-string/jumbo v3, "Installer la r\u00e9ponse quand m\u00eame ? [non] :  "
    ...
    const-string/jumbo v3, "Les cl\u00e9s publiques de la r\u00e9ponse et du Keystore ne concordent pas"
    ...
    const-string/jumbo v3, "La r\u00e9ponse au certificat et le certificat du Keystore sont identiques"
    ...
    const-string/jumbo v3, "Impossible de cr\u00e9er une cha\u00eene \u00e0 partir de la r\u00e9ponse"
    ...
    const-string/jumbo v3, "R\u00e9ponse incorrecte, recommencez"
    ...
    const-string/jumbo v3, "Cl\u00e9 secr\u00e8te non g\u00e9n\u00e9r\u00e9e, l\'alias <{0}> existe d\u00e9j\u00e0"
    ...
    const-string/jumbo v3, "Veuillez sp\u00e9cifier -keysize pour la g\u00e9n\u00e9ration de la cl\u00e9 secr\u00e8te"
    ...
    const-string/jumbo v3, "Syntaxe keytool :\n"
    ...
    const-string/jumbo v3, "\t     [-file <csr_file>] [-keypass <mot_passe_cl\u00e9>]"
    ...
    const-string/jumbo v3, "\t     [-keystore <keystore>] [-storepass <mot_passe_store>]"
    ...
    const-string/jumbo v3, "\t     [-alias <alias>] [-file <fichier_cert>]"
    ...
    const-string/jumbo v3, "\t     [-keyalg <keyalg>] [-keysize <taille_cl\u00e9>]"
    ...
    const-string/jumbo v3, "\t     [-sigalg <sigalg>] [-dname <nomd>]"
    ...
    const-string/jumbo v3, "\t     [-validity <joursVal>] [-keypass <mot_passe_cl\u00e9>]"
    ...
    const-string/jumbo v3, "\t     [-file <fichier_cert>] [-keypass <mot_passe_cl\u00e9>]"
    ...
    const-string/jumbo v3, "\t     [-keypass <ancien_mot_passe_cl\u00e9>] [-new <nouveau_mot_passe_cl\u00e9>]"
    ...
    const-string/jumbo v3, "-printcert   [-v] [-file <fichier_cert>]"
    ...
    const-string/jumbo v3, "Avertissement\u00a0: il n\'existe pas de cl\u00e9 publique pour l\'alias {0}.  V\u00e9rifiez que le keystore est correctement configur\u00e9."
    ...
    const-string/jumbo v3, "Avertissement : Classe introuvable : {0}"
    ...
    const-string/jumbo v3, "Avertissement\u00a0: argument(s) non valide(s) pour le constructeur\u00a0: {0}"
    ...
    const-string/jumbo v3, "Type de mandant non admis : {0}"
    ...
    const-string/jumbo v3, "Option non admise : {0}"
    ...
    const-string/jumbo v3, "Syntaxe : policytool [options]"
    ...
    const-string/jumbo v3, "  [-file <fichier>]    emplacement du fichier de r\u00e8gles"
    ...
    const-string/jumbo v3, "Enregistrer"
    ...
    const-string/jumbo v3, "Enregistrer sous"
    ...
    const-string/jumbo v3, "Afficher le journal des avertissements"
    ...
    const-string/jumbo v3, "Ajouter une r\u00e8gle"
    ...
    const-string/jumbo v3, "Modifier une r\u00e8gle"
    ...
    const-string/jumbo v3, "Supprimer une r\u00e8gle"
    ...
    const-string/jumbo v3, "Conserver"
    ...
    const-string/jumbo v3, "Ajouter un alias de cl\u00e9 publique"
    ...
    const-string/jumbo v3, "Supprimer un alias de cl\u00e9 publique"
    ...
    const-string/jumbo v3, "Fichier de r\u00e8gles :"
    ...
    const-string/jumbo v3, "Impossible d\'ouvrir le fichier de strat\u00e9gie\u00a0: {0}: {1}"
    ...
    const-string/jumbo v3, "Des erreurs se sont produites \u00e0 l\'ouverture de la configuration de r\u00e8gles. Consultez le journal des avertissements pour obtenir des informations."
    ...
    const-string/jumbo v3, "Avertissement"
    ...
    const-string/jumbo v3, "Type de principal :"
    ...
    const-string/jumbo v3, "Nom de principal :"
    ...
    const-string/jumbo v3, "Nom de cible :                                                    "
    ...
    const-string/jumbo v3, "Remplacer le fichier existant {0} ?"
    ...
    const-string/jumbo v3, "Base de code :"
    ...
    const-string/jumbo v3, "Sign\u00e9 par :"
    ...
    const-string/jumbo v3, "Ajouter un principal"
    ...
    const-string/jumbo v3, "Modifier un principal"
    ...
    const-string/jumbo v3, "Supprimer un principal"
    ...
    const-string/jumbo v3, "Principaux :"
    ...
    const-string/jumbo v3, " Ajouter une permission"
    ...
    const-string/jumbo v3, " Modifier une permission"
    ...
    const-string/jumbo v3, "Supprimer une permission"
    ...
    const-string/jumbo v3, "URL du KeyStore :"
    ...
    const-string/jumbo v3, "Type de KeyStore :"
    ...
    const-string/jumbo v3, "Fournisseur du KeyStore :"
    ...
    const-string/jumbo v3, "URL du mot de passe du KeyStore :"
    ...
    const-string/jumbo v3, "Impossible de sp\u00e9cifier un principal avec une classe g\u00e9n\u00e9rique sans nom de g\u00e9n\u00e9rique"
    ...
    const-string/jumbo v3, "Impossible de sp\u00e9cifier un principal sans nom"
    ...
    const-string/jumbo v3, "La permission et le nom de cible doivent avoir une valeur"
    ...
    const-string/jumbo v3, "Supprimer cette r\u00e8gle ?"
    ...
    const-string/jumbo v3, "Remplacer le fichier"
    ...
    const-string/jumbo v3, "R\u00e8gle enregistr\u00e9e dans {0}"
    ...
    const-string/jumbo v3, "Nom Null de fichier"
    ...
    const-string/jumbo v3, "Enregistrer les modifications ?"
    ...
    const-string/jumbo v3, "Enregistrer les changements"
    ...
    const-string/jumbo v3, "Aucune r\u00e8gle s\u00e9lectionn\u00e9e"
    ...
    const-string/jumbo v3, "Impossible d\'ouvrir le keystore\u00a0: {0}"
    ...
    const-string/jumbo v3, "Aucun principal s\u00e9lectionn\u00e9"
    ...
    const-string/jumbo v3, "Aucune permission s\u00e9lectionn\u00e9e"
    ...
    const-string/jumbo v3, "type de configuration"
    ...
    const-string/jumbo v3, "Nom variable de l\'environnement"
    ...
    const-string/jumbo v3, "nom de biblioth\u00e8que"
    ...
    const-string/jumbo v3, "nom de package"
    ...
    const-string/jumbo v3, "type de strat\u00e9gie"
    ...
    const-string/jumbo v3, "nom de propri\u00e9t\u00e9"
    ...
    const-string/jumbo v3, "nom de fournisseur"
    ...
    const-string/jumbo v3, "Liste de mandants"
    ...
    const-string/jumbo v3, "Liste de droits"
    ...
    const-string/jumbo v3, "Base de codes"
    ...
    const-string/jumbo v3, "Entr\u00e9e() Null non valide(s)"
    ...
    const-string/jumbo v3, "les actions peuvent \u00eatre accessibles en \'lecture\' uniquement"
    ...
    const-string/jumbo v3, "syntaxe de nom de permission [{0}] non valide : "
    ...
    const-string/jumbo v3, "Classe Credential non suivie d\'une classe et d\'un nom de principal"
    ...
    const-string/jumbo v3, "Classe de principal non suivie d\'un nom de principal"
    ...
    const-string/jumbo v3, "Le nom de principal doit \u00eatre entre guillemets"
    ...
    const-string/jumbo v3, "Guillemet fermant manquant pour nom de principal"
    ...
    const-string/jumbo v3, "La classe principale PrivateCredentialPermission ne peut \u00eatre une valeur g\u00e9n\u00e9rique (*) si le nom de principal n\'est pas une valeur g\u00e9n\u00e9rique (*)"
    ...
    const-string/jumbo v3, "Mappage des mots cl\u00e9s Null fourni"
    ...
    const-string/jumbo v3, "Mappage OID Null fourni"
    ...
    const-string/jumbo v3, "AccessControlContext Null sp\u00e9cifi\u00e9 non valide"
    ...
    const-string/jumbo v3, "action Null sp\u00e9cifi\u00e9e non valide"
    ...
    const-string/jumbo v3, "classe Null sp\u00e9cifi\u00e9e non valide"
    ...
    const-string/jumbo v3, "\tIdentit\u00e9 publique : "
    ...
    const-string/jumbo v3, "\tIdentit\u00e9s priv\u00e9es inaccessibles\n"
    ...
    const-string/jumbo v3, "\tIdentit\u00e9 priv\u00e9e : "
    ...
    const-string/jumbo v3, "\tIdentit\u00e9 priv\u00e9e inaccessible\n"
    ...
    const-string/jumbo v3, "Objet en lecture seule"
    ...
    const-string/jumbo v3, "tentative d\'ajout d\'un objet qui n\'est pas une instance de java.security.Principal dans un ensemble principal d\'objet"
    ...
    const-string/jumbo v3, "tentative d\'\'ajout d\'\'un objet qui n\'\'est pas une instance de {0}"
    ...
    const-string/jumbo v3, "Entr\u00e9e Null non valide : nom"
    ...
    const-string/jumbo v3, "Aucun LoginModule configur\u00e9 pour {0}"
    ...
    const-string/jumbo v3, "sujet Null sp\u00e9cifi\u00e9 non valide"
    ...
    const-string/jumbo v3, "CallbackHandler Null sp\u00e9cifi\u00e9 non valide"
    ...
    const-string/jumbo v3, "sujet Null - tentative de d\u00e9connexion avant connexion"
    ...
    const-string/jumbo v3, "impossible d\'\'instancier LoginModule {0} car il ne fournit pas de constructeur sans argument"
    ...
    const-string/jumbo v3, "impossible d\'instancier LoginModule"
    ...
    const-string/jumbo v3, "classe LoginModule introuvable : "
    ...
    const-string/jumbo v3, "impossible d\'acc\u00e9der \u00e0 LoginModule : "
    ...
    const-string/jumbo v3, "Echec de connexion : tous les modules ont \u00e9t\u00e9 ignor\u00e9s"
    ...
    const-string/jumbo v3, "java.security.policy : erreur d\'\'analyse de {0} :\n\t{1}"
    ...
    const-string/jumbo v3, "java.security.policy : erreur d\'\'ajout de permission, {0} :\n\t{1}"
    ...
    const-string/jumbo v3, "java.security.policy : erreur d\'\'ajout d\'\'entr\u00e9e :\n\t{0}"
    ...
    const-string/jumbo v3, "nom d\'\'alias non fourni ({0})"
    ...
    const-string/jumbo v3, "impossible d\'\'effectuer une substitution pour l\'\'alias, {0}"
    ...
    const-string/jumbo v3, "valeur de substitution, {0}, non prise en charge"
    ...
    const-string/jumbo v3, "le type ne peut \u00eatre Null"
    ...
    const-string/jumbo v3, "Impossible de sp\u00e9cifier keystorePasswordURL sans sp\u00e9cifier aussi le keystore"
    ...
    const-string/jumbo v3, "type keystore pr\u00e9vu"
    ...
    const-string/jumbo v3, "fournisseur keystore pr\u00e9vu"
    ...
    const-string/jumbo v3, "expressions Codebase multiples"
    ...
    const-string/jumbo v3, "expressions SignedBy multiples"
    ...
    const-string/jumbo v3, "SignedBy poss\u00e8de un alias vide"
    ...
    const-string/jumbo v3, "impossible de sp\u00e9cifier Principal avec une classe g\u00e9n\u00e9rique sans nom g\u00e9n\u00e9rique"
    ...
    const-string/jumbo v3, "codeBase ou SignedBy ou Principal pr\u00e9vu"
    ...
    const-string/jumbo v3, "entr\u00e9e de permission pr\u00e9vue"
    ...
    const-string/jumbo v3, "pr\u00e9vu [{0}], lecture [fin de fichier]"
    ...
    const-string/jumbo v3, "pr\u00e9vu [;], lecture [fin de fichier]"
    ...
    const-string/jumbo v3, "ligne {0} : {1}"
    ...
    const-string/jumbo v3, "ligne {0} : pr\u00e9vu [{1}], trouv\u00e9 [{2}]"
    ...
    const-string/jumbo v3, "principalClass ou principalName Null"
    ...
    const-string/jumbo v3, "Mot de passe PKCS11 Token [{0}] : "
    ...
    const-string/jumbo v3, "impossible d\'instancier la strat\u00e9gie Subject"
